...
extern int perseus_connect(sdr_data_t *sdr, gboolean ci, gboolean co);
extern int perseus_start(sdr_data_t *sdr, int bw);
extern int perseus_stop(sdr_data_t *sdr);
extern int perseus_update_freq(sdr_data_t *sdr); 
